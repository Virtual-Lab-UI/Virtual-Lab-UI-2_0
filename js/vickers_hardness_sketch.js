function sketch(p) {
    ...
    let filarBounds = [[-370, -245, -80, 35], [-235, -140, 35, 135]];
    ...
    p.preload = function() {
        ...
        sample = p.loadImage('images/sample_r_vickers.png');
    }
    ...
    p.checkVerticalFilars = function() {
        if (baseKnob.theta > filarBounds[0][0] && baseKnob.theta < filarBounds[0][1] && measuringKnob.theta + baseKnob.theta - baseKnob.theta0 > filarBounds[0][2] && measuringKnob.theta + baseKnob.theta - baseKnob.theta0 < filarBounds[0][3]) {
            inputButton.setCallback(p.checkHorizontalFilars);
            vertical = false;
            lensKnob.theta = -180;
        } else {
            p.textSize(16);
    ...
    p.checkHorizontalFilars = function() {
        if (baseKnob.theta > filarBounds[1][0] && baseKnob.theta < filarBounds[1][1] && measuringKnob.theta + baseKnob.theta - baseKnob.theta0 > filarBounds[1][2] && measuringKnob.theta + baseKnob.theta - baseKnob.theta0 < filarBounds[1][3] && lensKnob.theta > -100) {
            inputButton.setCallback(p.noCallback);
            p.done = true;
        } else {
            p.textSize(16);
            p.text("Please align filars", interactiveWidth * 9 / 10, interactiveHeight * 5 / 10);
